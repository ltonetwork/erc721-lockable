...
// Example: PARAMETERS=deployments/inputs/deploy_LockableNFT_forNFTParis.json npx hardhat run scripts/deploy_LockableNFT_forNFTParis.ts --network hardhat 2>&1 | tee scripts/logs/deploy_LockableNFT_forNFTParis_hardhat_20240131.log
// Example: PARAMETERS=deployments/inputs/deploy_LockableNFT_forNFTParis.json npx hardhat run scripts/deploy_LockableNFT_forNFTParis.ts --network arbitrumSepolia 2>&1 | tee scripts/logs/deploy_LockableNFT_forNFTParis_arbitrumSepolia_20240131.log
// Example: PARAMETERS=deployments/inputs/deploy_LockableNFT_forNFTParis.json npx hardhat run scripts/deploy_LockableNFT_forNFTParis.ts --network polygonMumbai 2>&1 | tee scripts/logs/deploy_LockableNFT_forNFTParis_polygonMumbai_20240201.log
async function main() {
